...
\let\thefootnote\relax\footnote{\centering{Keywords: {\color {magenta} Mathematics}, {\color {black} Statistics}, {\color {blue} Cosmology} , {\color {green} Astrophysics}, {\color {purple} Computing}}}
%\newpage 
